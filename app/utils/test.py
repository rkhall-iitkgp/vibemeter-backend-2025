    ...
    sample_data = [
        {
            ...
            "metrics": ["work_satisfaction_score", "reported_stress_levels", "work_hour_flexibility", "burnout_index"]
        },
        {
            ...
            "metrics": ["career_satisfaction", "skill_development_rate", "internal_promotion_percentage", "training_program_effectiveness"]
        },
        {
            ...
            "metrics": ["belonging_index", "team_cohesion_score", "cross-department_collaboration_rate", "employee_isolation_levels"]
        },
        {
            ...
            "metrics": ["mental_health_utilization", "wellness_program_participation", "absenteeism_rate", "health_risk_assessment_scores"]
        },
        {
            ...
            "metrics": ["inclusion_survey_results", "demographic_representation", "pay_equity_measurements", "promotion_equality_index"]
        }
    ]
