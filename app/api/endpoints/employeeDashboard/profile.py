...
from app.models.schema import User, OnboardingDataset, RewardsDataset
...
async def get_employee_profile(
    ...
    joining_date_result = db.query(OnboardingDataset).filter(
        OnboardingDataset.employee_id == employee_id
    ).first()
    ...
    awards = db.query(RewardsDataset).filter(
        RewardsDataset.employee_id == employee_id
    ).all()
